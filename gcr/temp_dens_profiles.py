...
#            continue
    ...
    return (xx_rad, yy_temps, yy_dens, wavelengths, spectlist, filelist)
            
xx, yy1, yy2, wavelengths, spectlist, \
filelist = retrieve_file_dir_data(spect_dir)
...
plt.xlim(0,40)
plt.ylim(3,8)   
plt.title('ALEXIS: Radial electron temperature profiles', weight="bold")
plt.ylabel('Electron Temperature (eV)')
plt.xlabel('Radial Position (mm)')
plt.savefig('temp_profiles.png', dpi=300)
plt.show(fig1)
...
plt.xlim(0,40)
plt.ylim(0, 3.5e16)   
plt.title('ALEXIS: Radial electron density profiles', weight="bold")
plt.ylabel('Electron Density ' + r'($m^{-3}$)')
plt.xlabel('Radial Position (mm)')
plt.savefig('dens_profiles.png', dpi=300)
plt.show(fig1)
...
for i in range(24):
    plt.plot(wavelengths, spectlist[i])

plt.xlim(200,1100)
plt.ylim(0, 57000)   
plt.title('ALEXIS: All spectra collected at viewport 1', weight="bold")
plt.xlabel('Wavelength (nm)')
plt.ylabel('Emission (CCD counts)')
plt.savefig('spect_profiles.png', dpi=300)
plt.show(fig3)
